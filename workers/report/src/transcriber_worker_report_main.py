# FILE: workers/report/src/transcriber_worker_report_main.py
# VERSION: 1.0.0
# START_MODULE_CONTRACT
# PURPOSE: Provide the compose-ready executable launcher for the report worker.
# SCOPE: Runtime env loading, shared worker loop wiring, MinIO object-store adapter wiring, and report runner construction.
...
#   LAST_CHANGE: v1.0.0 - Added the compose-ready report worker launcher wired through worker-common runtime.
# END_CHANGE_SUMMARY
#
# START_MODULE_MAP
#   launch-report-worker - Build the API client, object-store adapter, and shared worker loop.
#   build-report-runner - Adapt claimed job IDs into runReport calls without duplicating queue logic.
# END_MODULE_MAP
...
from transcriber_worker_report import runReport
...
_LOG_MARKER_LAUNCH_REPORT = "[WorkerReport][main][BLOCK_LAUNCH_REPORT_WORKER]"
...
def main(env: Mapping[str, str] | None = None) -> int:
    ...
    _LOGGER.info("%s workspace_root=%s", _LOG_MARKER_LAUNCH_REPORT, config.workspace_root)
