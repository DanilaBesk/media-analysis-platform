# FILE: workers/transcription/tests/test_worker_common_api_reuse.py
# VERSION: 1.0.0
...
#   LAST_CHANGE: v1.0.0 - Reused packet-relevant worker-common API and artifact tests inside the transcription worker verification suite.
# END_CHANGE_SUMMARY
#
# START_MODULE_MAP
