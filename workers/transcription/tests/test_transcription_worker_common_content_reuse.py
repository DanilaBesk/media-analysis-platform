...
# PURPOSE: Reuse the canonical worker-common document helper verification slices inside the transcription worker packet-local suite.
# SCOPE: Re-export shared transcript/docx/report-rendering tests so the transcription packet gate covers the exact helper behavior it depends on.
