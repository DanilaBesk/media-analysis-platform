...
class OrderedWorkerInput:
    ...
    def __post_init__(self) -> None:
        ...
        _require(self.source_kind in {"uploaded_file", "telegram_upload", "youtube_url"}, "invalid ordered input source_kind")
    ...
    def from_payload(cls, payload: object) -> "OrderedWorkerInput":
        ...
        _ensure_allowed_keys(
            ...
            optional={"display_name", "original_filename", "object_key", "source_url", "sha256", "size_bytes"},
...
class ClaimedJobExecution:
    ...
    def __post_init__(self) -> None:
        ...
        _require(bool(self.ordered_inputs), "claimed job must include at least one ordered input")
    ...
    def from_payload(cls, payload: object) -> "ClaimedJobExecution":
        ...
        _require(isinstance(ordered_inputs_payload, list) and ordered_inputs_payload, "claim response ordered_inputs must be a non-empty list")
