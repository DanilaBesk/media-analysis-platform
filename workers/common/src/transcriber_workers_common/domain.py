...
#
# START_MODULE_MAP
#   SourceKind - Canonical source-kind literal values.
#   MediaKind - Canonical Telegram media-kind literal values.
#   MediaAttachment - Telegram media attachment contract.
#   SourceCandidate - Canonical source candidate contract.
#   ExtractionResult - Source extraction result contract.
#   TranscriptSegment - Transcript segment contract.
