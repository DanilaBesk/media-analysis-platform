...
// SCOPE: Verify envelope normalization, multipart payload shaping, error handling, websocket path normalization, and reconciliation helpers.
...
//   LAST_CHANGE: v1.0.0 - Expanded the client tests to cover job envelopes, multipart create flows, websocket normalization, and reconciliation helpers.
// END_CHANGE_SUMMARY
//
// START_MODULE_MAP
...
//   verify-event-boundary - Confirm websocket subscription parses canonical messages and normalizes legacy local paths.
...
describe("createWebUiApiClient", () => {
  ...
  it("normalizes websocket urls and forwards canonical event envelopes", () => {
