...
validate_static_contract() {
  ...
  require_file_snippet "${RUNTIME_E2E_SCRIPT}" "RUNTIME_E2E_MINIO_HOST_ENDPOINT"
  require_file_snippet "${RUNTIME_E2E_SCRIPT}" "MINIO_HOST_PORT"
  ...
  require_service_block_snippet "minio" '${MINIO_HOST_PORT:-19100}:9000'
  require_service_block_snippet "minio" '${MINIO_CONSOLE_HOST_PORT:-19101}:9001'
  require_service_block_snippet "api" "healthcheck:"
  require_service_block_snippet "api" "channel-accounts?page_size=1"
  require_service_block_snippet "api" "MINIO_PUBLIC_ENDPOINT: *platform-minio-public-endpoint"
  require_service_block_snippet "api" "api-go-build-cache:/root/.cache/go-build"
  require_service_block_snippet "api" "api-go-mod-cache:/go/pkg/mod"
  require_service_block_snippet "api" '${API_HEALTH_START_PERIOD:-4m}'
  ...
  require_service_block_snippet "worker-transcription" "MINIO_PUBLIC_ENDPOINT: *platform-minio-public-endpoint"
  ...
  require_service_block_snippet "worker-agent-runner" "MINIO_PUBLIC_ENDPOINT: *platform-minio-public-endpoint"
  require_service_block_snippet "worker-agent-runner" "condition: service_healthy"
  ...
  require_file_snippet "${ROOT_DIR}/infra/images/worker-agent-runner/Dockerfile" "FROM node:22-bookworm-slim AS node-runtime"
  require_file_snippet "${ROOT_DIR}/infra/images/worker-agent-runner/Dockerfile" "COPY --from=node-runtime /usr/local/bin/node /usr/local/bin/node"
  ...
  require_file_snippet "${ROOT_DIR}/infra/env/telegram-bot.env.example" "TELEGRAM_BOT_API_REQUIRED=true"
  ...
  require_service_block_snippet "telegram-bot" "TELEGRAM_BOT_API_REQUIRED: \"true\""
